    ...
    const AdmissionManagementContent:React.FC=()=>{
        ...
        return(
            <div className="d-flex admission-content flex-column align-items-start">
                ...
                <h4 className="my-4 ">What is an Admission Management Software?</h4>
                ...
                <h5 className="my-3 ">Admission Management Software for Schools</h5>
                ...
                <h5 className="my-3">Characteristics of Admission Management Software</h5>
